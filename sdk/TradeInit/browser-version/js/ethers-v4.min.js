    ...
    return function o(s, a, u) {
            ...
            function (e, t, r) {
                ...
                function w(o, e, s) {
                    ...
                    return function () {
                        ...
                        if (e.length === a.inputs.length + 1 && "object" == typeof e[e.length - 1]) 
                            for (
                                var n in null != (i = p.shallowCopy(e.pop())).blockTag && (r = i.blockTag),
                                delete i.blockTag,
                                i
                            ) 
                                if (!b[n]) 
                    ...
                    if (e.length != a.inputs.length) 
                        ...
                        function n(i, o, e) {
                            ...
                            if ("address" === e.type) 
                                return i.resolveName(o);
                            if ("tuple" === e.type) 
                                return n(i, o, e.components);
                            var t = e
                                .type
                                .match(/(.*)(\[[0-9]*\]$)/);
                            if (t) {
                                ...
                                return s
                                    ...
                                    : (
                                        ...
                                        o.provider.call(i, r).then(function (t) {
                                            ...
                                            try {
                                                var r = a.decode(t);
                                                return 1 === a.outputs.length && (r = r[0]),
                                                r
                                            } catch (e) {
                                                throw "0x" === t && 0 < a.outputs.length && l.throwError(
                                                    "call exception",
                                                    l.CALL_EXCEPTION,
                                                    {
                                                        address: o.address,
                            ...
                            if ("transaction" === a.type) 
                                return s
                                    ...
                                    : (
                                        null == i.gasLimit && null != a.gas && (i.gasLimit = f.bigNumberify(a.gas).add(21e3)),
                                        o.signer || l.throwError(
                                            "sending a transaction requires a signer",
                                            l.UNSUPPORTED_OPERATION,
                                            {operation: "sendTransaction"}
                                        ),
                                        null != i.from && l.throwError(
                                                    ...
                                                    return n.events = n
                                                        ...
                                                        .map(function (e) {
                                                            ...
                                                            t.getTransaction = function () {
                                                                return o
                                                                    .provider
                                                                    .getTransaction(n.transactionHash)
                                                            },
                ...
                var M = (
                    ...
                    A.prototype.connect = function (e) {
                        ...
                        return this.deployTransaction && p.defineReadOnly(
                            t,
                            "deployTransaction",
                            this.deployTransaction
                        ),
                    ...
                    A.prototype._addEventListener = function (n, i, e) {
                        ...
                        function t(e) {
                            ...
                            o
                                .emit
                                .apply(o, [n.filter].concat(r))
                        }
                        this.provider || l.throwError(
                        ...
                        this
                            ._events
                            .push({eventFilter: n, listener: i, wrappedListener: t, once: e})
                    },
                    ...
                    A.prototype.removeAllListeners = function (e) {
                        ...
                        return this._events = this
                            ._events
                            .filter(function (e) {
                                return e.eventFilter.eventTag !== r.eventTag || (
                                    t.provider.removeListener(e.eventFilter.filter, e.wrappedListener),
                                    !1
                                )
                            }),
                        this
                    ...
                    A.prototype.removeListener = function (e, t) {
                        ...
                        return this._events = this
                            ._events
                            .filter(function (e) {
                                return e.eventFilter.eventTag !== i.eventTag || e.listener !== t || (
                                    r.provider.removeListener(e.eventFilter.filter, e.wrappedListener),
                                    !!n || !(n = !0)
                                )
                            }),
                        this
                    ...
                    if (
                        ...
                        y.Signer.isSigner(r)
                            ...
                            : v.Provider.isProvider(r)
                                ...
                                : l.throwError("invalid signer or provider", l.INVALID_ARGUMENT, {
                        ...
                        p.defineReadOnly(
                            this,
                            "addressPromise",
                            this.provider.resolveName(t).then(function (e) {
                                if (null == e) 
                    ...
                    S.prototype.deploy = function () {
                        ...
                        return this
                            ...
                            .then(function (e) {
                                ...
                                return p.defineReadOnly(t, "deployTransaction", e),
                                t
                            })
                    },
                ...
                function S(e, t, r) {
                    ...
                    "string" == typeof t
                        ...
                        : c.isArrayish(t)
                            ...
                            : "string" == typeof t.object
                                ? n = t.object
                                : l.throwError("bytecode must be a valid hex string", l.INVALID_ARGUMENT, {
                                    arg: "bytecode",
                                    value: t
                                }),
                    "0x" !== n.substring(0, 2) && (n = "0x" + n),
                    c.isHexString(n) || l.throwError(
                    ...
                    r && !y
                        .Signer
                        .isSigner(r) && l.throwError("invalid signer", l.INVALID_ARGUMENT, {
                        arg: "signer",
                        value: null
                    }),
        ...
        5: [
            function (e, t, s) {
                ...
                s.checkNew = function (e, t) {
                    e instanceof t || n("missing new", s.MISSING_NEW, {name: t.name})
                },
                s.checkArgumentCount = function (e, t, r) {
                    r = r || "",
                    e < t && n("missing argument" + r, s.MISSING_ARGUMENT, {
                        count: e,
                        expectedCount: t
                    }),
        ...
        6: [
            function (e, t, r) {
                ...
                r.getDefaultProvider = function (e) {
                    ...
                    return t && t._defaultProvider || u.throwError(
                ...
                !function (e) {
                                ...
                                for (var t = [], r = 0; r < e.length;) {
                                    ...
                                    n < 128
                                        ...
                                        : 191 < n && n < 224
                                            ...
                                            : (
                                                t.push(String.fromCharCode((15 & n) << 12 | (63 & e[r + 1]) << 6 | 63 & e[r + 2])),
                                                r += 3
                                            )
                                }
                                return t.join("")
                    ...
                    k.prototype._prepare = function () {
                        ...
                        for (var l = 1; l < e; l++) 
                            for (var h = 0; h < 4; h++) 
                                s = this._Kd[l][h],
                                this._Kd[l][h] = _[s >> 24 & 255] ^ M[s >> 16 & 255] ^ A[s >> 8 & 255] ^ E[255 & s]
                    },
                    k.prototype.encrypt = function (e) {
                        ...
                        for (i = 0; i < 4; i++) 
                            ...
                            a[4 * i + 1] = 255 & (d[n[(i + 1) % 4] >> 16 & 255] ^ s >> 16),
                            a[4 * i + 2] = 255 & (d[n[(i + 2) % 4] >> 8 & 255] ^ s >> 8),
                    ...
                    k.prototype.decrypt = function (e) {
                        ...
                        for (i = 0; i < 4; i++) 
                            ...
                            a[4 * i + 1] = 255 & (l[n[(i + 3) % 4] >> 16 & 255] ^ s >> 16),
                            a[4 * i + 2] = 255 & (l[n[(i + 2) % 4] >> 8 & 255] ^ s >> 8),
        ...
        9: [
            function (A, e, t) {
                !function (e, t) {
                    ...
                    m.isBN = function (e) {
                        return e instanceof m || null !== e && "object" == typeof e && e.constructor.wordSize === m.wordSize && Array.isArray(
                            e.words
                        )
                    },
                    m.max = function (e, t) {
                    ...
                    m.prototype._initNumber = function (e, t, r) {
                        ...
                        e < 67108864
                            ...
                            : e < 4503599627370496
                                ...
                                : (y(e < 9007199254740992), this.words = [
                                    67108863 & e,
                                    e / 67108864 & 67108863,
                                    1
                                ], this.length = 3),
                    ...
                    function i(e, t, r) {
                        ...
                        for (var l = 1; l < n; l++) {
                            for (
                                ...
                                var p = l - d | 0;
                                h += (s = (i = 0 | e.words[p]) * (o = 0 | t.words[d]) + f) / 67108864 | 0,
                                f = 67108863 & s
                            }
                            r.words[l] = 0 | f,
                            u = 0 | h
                    ...
                    m.prototype.toString = function (e, t) {
                        ...
                        if (t = 0 | t || 1, 16 === (e = e || 10) || "hex" === e) {
                            ...
                            for (var n = 0, i = 0, o = 0; o < this.length; o++) {
                                ...
                                r = 0 !== (i = s >>> 24 - n & 16777215) || o !== this.length - 1
                                    ? c[6 - a.length] + a + r
                                    : a + r,
                                26 <= (n += 2) && (n -= 26, o--)
                            }
                    ...
                    m.prototype.toNumber = function () {
                        ...
                        return 2 === this.length
                            ...
                            : 3 === this.length && 1 === this.words[2]
                                ...
                                : 2 < this.length && y(!1, "Number can only safely store up to 53 bits"),
                        0 !== this.negative
                            ? -e
                            : e
                    },
                    ...
                    m.prototype.ior = function (e) {
                        return y(0 == (this.negative | e.negative)),
                        this.iuor(e)
                    },
                    ...
                    m.prototype.inotn = function (e) {
                        ...
                        return 0 < r && (this.words[n] = ~this.words[n] & 67108863 >> 26 - r),
                        this.strip()
                    },
                    ...
                    var o = function (e, t, r) {
                        ...
                        r.length = 19;
                        var ye = (l + (n = Math.imul(f, G)) | 0) + (
                            (8191 & (i = (i = Math.imul(f, H)) + Math.imul(c, G) | 0)) << 13
                        ) | 0;
                        l = ((o = Math.imul(c, H)) + (i >>> 13) | 0) + (ye >>> 26) | 0,
                        ye &= 67108863,
                        n = Math.imul(p, G),
                        i = (i = Math.imul(p, H)) + Math.imul(v, G) | 0,
                        o = Math.imul(v, H);
                        var me = (l + (n = n + Math.imul(f, V) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(f, K) | 0) + Math.imul(c, V) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(c, K) | 0) + (i >>> 13) | 0) + (me >>> 26) | 0,
                        me &= 67108863,
                        n = Math.imul(m, G),
                        ...
                        o = o + Math.imul(v, K) | 0;
                        var ge = (l + (n = n + Math.imul(f, W) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(f, Z) | 0) + Math.imul(c, W) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(c, Z) | 0) + (i >>> 13) | 0) + (ge >>> 26) | 0,
                        ge &= 67108863,
                        n = Math.imul(w, G),
                        ...
                        o = o + Math.imul(v, Z) | 0;
                        var be = (l + (n = n + Math.imul(f, X) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(f, $) | 0) + Math.imul(c, X) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(c, $) | 0) + (i >>> 13) | 0) + (be >>> 26) | 0,
                        be &= 67108863,
                        n = Math.imul(A, G),
                        ...
                        o = o + Math.imul(v, $) | 0;
                        var we = (l + (n = n + Math.imul(f, Y) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(f, ee) | 0) + Math.imul(c, Y) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(c, ee) | 0) + (i >>> 13) | 0) + (we >>> 26) | 0,
                        we &= 67108863,
                        n = Math.imul(k, G),
                        ...
                        var _e = (l + (n = n + Math.imul(f, re) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(f, ne) | 0) + Math.imul(c, re) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(c, ne) | 0) + (i >>> 13) | 0) + (_e >>> 26) | 0,
                        _e &= 67108863,
                        n = Math.imul(P, G),
                        ...
                        var Me = (l + (n = n + Math.imul(f, oe) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(f, se) | 0) + Math.imul(c, oe) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(c, se) | 0) + (i >>> 13) | 0) + (Me >>> 26) | 0,
                        Me &= 67108863,
                        n = Math.imul(R, G),
                        ...
                        var Ae = (l + (n = n + Math.imul(f, ue) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(f, le) | 0) + Math.imul(c, ue) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(c, le) | 0) + (i >>> 13) | 0) + (Ae >>> 26) | 0,
                        Ae &= 67108863,
                        n = Math.imul(L, G),
                        ...
                        var Ee = (l + (n = n + Math.imul(f, fe) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(f, ce) | 0) + Math.imul(c, fe) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(c, ce) | 0) + (i >>> 13) | 0) + (Ee >>> 26) | 0,
                        Ee &= 67108863,
                        n = Math.imul(U, G),
                        ...
                        var Se = (l + (n = n + Math.imul(f, pe) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(f, ve) | 0) + Math.imul(c, pe) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(c, ve) | 0) + (i >>> 13) | 0) + (Se >>> 26) | 0,
                        Se &= 67108863,
                        n = Math.imul(U, V),
                        ...
                        var ke = (l + (n = n + Math.imul(p, pe) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(p, ve) | 0) + Math.imul(v, pe) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(v, ve) | 0) + (i >>> 13) | 0) + (ke >>> 26) | 0,
                        ke &= 67108863,
                        n = Math.imul(U, W),
                        ...
                        var Ne = (l + (n = n + Math.imul(m, pe) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(m, ve) | 0) + Math.imul(g, pe) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(g, ve) | 0) + (i >>> 13) | 0) + (Ne >>> 26) | 0,
                        Ne &= 67108863,
                        n = Math.imul(U, X),
                        ...
                        var xe = (l + (n = n + Math.imul(w, pe) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(w, ve) | 0) + Math.imul(_, pe) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(_, ve) | 0) + (i >>> 13) | 0) + (xe >>> 26) | 0,
                        xe &= 67108863,
                        n = Math.imul(U, Y),
                        ...
                        var Pe = (l + (n = n + Math.imul(A, pe) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(A, ve) | 0) + Math.imul(E, pe) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(E, ve) | 0) + (i >>> 13) | 0) + (Pe >>> 26) | 0,
                        Pe &= 67108863,
                        n = Math.imul(U, re),
                        ...
                        var Ie = (l + (n = n + Math.imul(k, pe) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(k, ve) | 0) + Math.imul(N, pe) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(N, ve) | 0) + (i >>> 13) | 0) + (Ie >>> 26) | 0,
                        Ie &= 67108863,
                        n = Math.imul(U, oe),
                        ...
                        var Te = (l + (n = n + Math.imul(P, pe) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(P, ve) | 0) + Math.imul(I, pe) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(I, ve) | 0) + (i >>> 13) | 0) + (Te >>> 26) | 0,
                        Te &= 67108863,
                        n = Math.imul(U, ue),
                        ...
                        var Re = (l + (n = n + Math.imul(R, pe) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(R, ve) | 0) + Math.imul(O, pe) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(O, ve) | 0) + (i >>> 13) | 0) + (Re >>> 26) | 0,
                        Re &= 67108863,
                        n = Math.imul(U, fe),
                        i = (i = Math.imul(U, ce)) + Math.imul(F, fe) | 0,
                        o = Math.imul(F, ce);
                        var Oe = (l + (n = n + Math.imul(L, pe) | 0) | 0) + (
                            (8191 & (i = (i = i + Math.imul(L, ve) | 0) + Math.imul(D, pe) | 0)) << 13
                        ) | 0;
                        l = ((o = o + Math.imul(D, ve) | 0) + (i >>> 13) | 0) + (Oe >>> 26) | 0,
                        Oe &= 67108863;
                        var Ce = (l + (n = Math.imul(U, pe)) | 0) + (
                            (8191 & (i = (i = Math.imul(U, ve)) + Math.imul(F, pe) | 0)) << 13
                        ) | 0;
                        return l = ((o = Math.imul(F, ve)) + (i >>> 13) | 0) + (Ce >>> 26) | 0,
                        Ce &= 67108863,
                        u[0] = ye,
                        u[1] = me,
                        u[2] = ge,
                                        ...
                                        for (var n = 0, i = 0, o = 0; o < r.length - 1; o++) {
                                            ...
                                            for (
                                                ...
                                                var h = o - l,
                                                    ...
                                                    c = 67108863 & f;
                                                a = 67108863 & (c = c + a | 0),
                                                i += (s = (s = s + (f / 67108864 | 0) | 0) + (c >>> 26) | 0) >>> 26,
                                                s &= 67108863
                                            }
                                            r.words[o] = a,
                                            n = s,
                    ...
                    m.prototype.imaskn = function (e) {
                        ...
                        var t = e % 26,
                            r = (e - t) / 26;
                        if (
                            y(0 === this.negative, "imaskn works only with positive numbers"),
                            this.length <= r
                        ) 
                            return this;
                    ...
                    m.prototype._wordDiv = function (e, t) {
                        ...
                        for (var h = a - 1; 0 <= h; h--) {
                            var f = 67108864 * (0 | n.words[i.length + h]) + (
                    ...
                    m.prototype.divmod = function (e, t, r) {
                        ...
                        this.isZero()
                            ...
                            : 0 !== this.negative && 0 === e.negative
                                ...
                                : 0 === this.negative && 0 !== e.negative
                                    ? (o = this.divmod(e.neg(), t), "mod" !== t && (n = o.div.neg()), {
                                        div: n,
                                        mod: o.mod
                                    })
                    ...
                    m.prototype.bincn = function (e) {
                        ...
                        return 0 !== i && (this.words[o] = i, this.length++),
                        this
                    },
                    ...
                    m.prototype.cmpn = function (e) {
                        ...
                        if (this.strip(), 1 < this.length) 
                            ...
                            r && (e = -e),
                            y(e <= 67108863, "Number is too big");
                    ...
                    m.prototype.toRed = function (e) {
                        return y(!this.red, "Already a number in reduction context"),
                    ...
                    m.prototype.fromRed = function () {
                        return y(this.red, "fromRed works only with numbers in reduction context"),
                        this
                            .red
                            .convertFrom(this)
                    },
                    ...
                    m.prototype.redAdd = function (e) {
                        return y(this.red, "redAdd works only with red numbers"),
                        this
                            .red
                            .add(this, e)
                    },
                    m.prototype.redIAdd = function (e) {
                        return y(this.red, "redIAdd works only with red numbers"),
                        this
                            .red
                            .iadd(this, e)
                    },
                    m.prototype.redSub = function (e) {
                        return y(this.red, "redSub works only with red numbers"),
                        this
                            .red
                            .sub(this, e)
                    },
                    m.prototype.redISub = function (e) {
                        return y(this.red, "redISub works only with red numbers"),
                        this
                            .red
                            .isub(this, e)
                    },
                    m.prototype.redShl = function (e) {
                        return y(this.red, "redShl works only with red numbers"),
                        this
                            .red
                            .shl(this, e)
                    },
                    m.prototype.redMul = function (e) {
                        return y(this.red, "redMul works only with red numbers"),
                        this
                            .red
                            ._verify2(this, e),
                        this
                    ...
                    m.prototype.redSqr = function () {
                        return y(this.red, "redSqr works only with red numbers"),
                        this
                            .red
                            ._verify1(this),
                        this
                    ...
                    m.prototype.redISqr = function () {
                        return y(this.red, "redISqr works only with red numbers"),
                        this
                            .red
                            ._verify1(this),
                        this
                    ...
                    m.prototype.redSqrt = function () {
                        return y(this.red, "redSqrt works only with red numbers"),
                        this
                            .red
                            ._verify1(this),
                        this
                    ...
                    m.prototype.redInvm = function () {
                        return y(this.red, "redInvm works only with red numbers"),
                        this
                            .red
                            ._verify1(this),
                        this
                    ...
                    m.prototype.redNeg = function () {
                        return y(this.red, "redNeg works only with red numbers"),
                        this
                            .red
                            ._verify1(this),
                        this
                    ...
                    m.prototype.redPow = function (e) {
                        return y(this.red && !e.red, "redPow(normalNum)"),
                        this
                            .red
                            ._verify1(this),
                        this
                    ...
                    _.prototype._verify2 = function (e, t) {
                        y(0 == (e.negative | t.negative), "red works only with positives"),
                        y(e.red && e.red === t.red, "red works only with red numbers")
                    },
                            ...
                            for (var u = t.words[n], l = a - 1; 0 <= l; l--) {
                                ...
                                0 != h || 0 !== o
                                    ? (
                                        o <<= 1,
                                        o |= h,
                                        (4 === ++s || 0 === n && 0 === l) && (i = this.mul(i, r[o]), o = s = 0)
                                    )
                                    : s = 0
                            }
                            a = 26
                    ...
                    M.prototype.invm = function (e) {
                        return this
                            .imod(e._invmp(this.m).mul(this.r2))
                            ._forceRed(this)
                    }
                }(void 0 === e || e, this)
            }, {
                    ...
                    for (l = n - 1; 1 <= l; l -= 2) {
                        ...
                        if (1 === o[f] && 1 === o[c]) {
                            ...
                            0 === t[f]
                                .y
                                .cmp(t[c].y)
                                    ? (d[1] = t[f].add(t[c]), d[2] = t[f].toJ().mixedAdd(t[c].neg()))
                                    : 0 === t[f]
                                        .y
                                        .cmp(t[c].y.redNeg())
                                            ? (d[1] = t[f].toJ().mixedAdd(t[c]), d[2] = t[f].add(t[c].neg()))
                                            : (d[1] = t[f].toJ().mixedAdd(t[c]), d[2] = t[f].toJ().mixedAdd(t[c].neg()));
                            var p = [
                                    -3,
                                    -1,
                                    -5,
            ...
            function (e, t, r) {
                ...
                (t.exports = a).prototype._getEndomorphism = function (e) {
                    if (this.zeroA && this.g && this.n && 1 === this.p.modn(3)) {
                        var t,
                            r;
                        if (e.beta) 
                            t = new _(e.beta, 16).toRed(this.red);
                        else {
                        ...
                        if (e.lambda) 
                            ...
                            0 === this
                                ...
                                .mul(i[0])
                                .x
                                .cmp(this.g.x.redMul(t))
                                    ? r = i[0]
                                    : (r = i[1], s(0 === this.g.mul(r).x.cmp(this.g.x.redMul(t))))
                        }
                        return {
                            beta: t,
                            lambda: r,
                ...
                u.prototype._getBeta = function () {
                    if (this.curve.endo) {
                        ...
                        var t = this
                            .curve
                            .point(this.x.redMul(this.curve.endo.beta), this.y);
                        if (e) {
                            var r = this.curve,
                                n = function (e) {
                ...
                u.prototype.toJSON = function () {
                    return this.precomputed
                        ? [
                            this.x, this.y, this.precomputed && {
                ...
                u.prototype.jmulAdd = function (e, t, r) {
                    ...
                    return this.curve.endo
                        ? this
                            .curve
                            ._endoWnafMulAdd(n, i, !0)
                        : this
                            .curve
                            ._wnafMulAdd(1, n, i, 2, !0)
                },
                u.prototype.eq = function (e) {
                    return this === e || this.inf === e.inf && (
                ...
                u.prototype.toJ = function () {
                    return this.inf
                        ...
                        : this
                            .curve
                            .jpoint(this.x, this.y, this.curve.one)
                },
                i(l, o.BasePoint),
                ...
                l.prototype.neg = function () {
                    return this
                        .curve
                        .jpoint(this.x, this.y.redNeg(), this.z)
                },
                ...
                l.prototype.trpl = function () {
                    ...
                    var c = this
                        .y
                        .redMul(l.redMul(u.redISub(l)).redISub(s.redMul(a)));
                    c = (c = (c = c.redIAdd(c)).redIAdd(c)).redIAdd(c);
                    var d = this
                        .z
                        .redAdd(s)
        ...
        18: [
            function (e, t, r) {
                ...
                l("p384", {
                    type: "short",
                    prime: null,
                    p: "ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff fffffffe ffffff" +
                            "ff 00000000 00000000 ffffffff",
                    a: "ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff fffffffe ffffff" +
                            "ff 00000000 00000000 fffffffc",
                    b: "b3312fa7 e23ee7e4 988e056b e3f82d19 181d9c6e fe814112 0314088f 5013875a c65639" +
                            "8d 8a2ed19d 2a85c8ed d3ec2aef",
                    n: "ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff c7634d81 f4372ddf 581a0d" +
                            "b2 48b0a77a ecec196a ccc52973",
                    hash: o.sha384,
                    gRed: !1,
                    g: [
                        "aa87ca22 be8b0537 8eb1c71e f320ad74 6e1d3b62 8ba79b98 59f741e0 82542a38 5502f2" +
                                "5d bf55296c 3a545e38 72760ab7",
                        "3617de4a 96262c6f 5d9e98bf 9292dc29 f8f41dbd 289a147c e9da3113 b5f0b8c0 0a60b1" +
                                "ce 1d7e819d 7a431d7c 90ea0e5f"
                    ]
                }),
                l("p521", {
                    type: "short",
                    prime: null,
                    p: "000001ff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff ffffff" +
                            "ff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff",
                    a: "000001ff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff ffffff" +
                            "ff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff fffffffc",
                    b: "00000051 953eb961 8e1c9a1f 929a21a0 b68540ee a2da725b 99b315f3 b8b48991 8ef109" +
                            "e1 56193951 ec7e937b 1652c0bd 3bb1bf07 3573df88 3d2c34f1 ef451fd4 6b503f00",
                    n: "000001ff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff ffffff" +
                            "fa 51868783 bf2f966b 7fcc0148 f709a5d0 3bb5c9b8 899c47ae bb6fb71e 91386409",
                    hash: o.sha512,
                    gRed: !1,
                    g: [
                        "000000c6 858e06b7 0404e9cd 9e3ecb66 2395b442 9c648139 053fb521 f828af60 6b4d3d" +
                                "ba a14b5e77 efe75928 fe1dc127 a2ffa8de 3348b3c1 856a429b f97e7e31 c2e5bd66",
                        "00000118 39296a78 9a3bc004 5c8a5fb4 2c7d1bd9 98f54449 579b4468 17afbd17 273e66" +
                                "2c 97ee7299 5ef42640 c550b901 3fad0761 353c7086 a272c240 88be9476 9fd16650"
                    ]
                }),
                l("curve25519", {
                    type: "mont",
        ...
        19: [
            function (e, t, r) {
                ...
                function a(e) {
                    ...
                    "string" == typeof e && (
                        d(i.hasOwnProperty(e), "Unknown curve " + e),
                        e = i[e]
                    ),
                    ...
                    this
                        .g
                        .precompute(e.curve.n.bitLength() + 1),
                ...
                a.prototype.sign = function (e, t, r, n) {
                    ...
                    for (
                        ...
                        var h = n.k
                            ? n.k(l)
                            : new y(a.generate(this.n.byteLength()));
                            ...
                            if (!f.isInfinity()) {
                                ...
                                if (0 !== d.cmpn(0)) {
                                    ...
                                    if (0 !== (p = p.umod(this.n)).cmpn(0)) {
                                        ...
                                        return n.canonical && 0 < p.cmp(this.nh) && (p = this.n.sub(p), v ^= 1),
                ...
                a.prototype.verify = function (e, t, r, n) {
                    ...
                    var i = (t = new g(t, "hex")).r,
                        o = t.s;
                    if (i.cmpn(1) < 0 || 0 <= i.cmp(this.n)) 
                        return !1;
                    if (o.cmpn(1) < 0 || 0 <= o.cmp(this.n)) 
                        return !1;
                    var s,
                        a = o.invm(this.n),
                        u = a
                    ...
                    return this.curve._maxwellTrick
                        ? !(s = this.g.jmulAdd(u, r.getPublic(), l)).isInfinity() && s.eqXToP(i)
                        : !(s = this.g.mulAdd(u, r.getPublic(), l)).isInfinity() && 0 === s
                            .getX()
                            .umod(this.n)
                            .cmp(i)
                },
                a.prototype.recoverPubKey = function (e, t, r, n) {
                    ...
                    s = l
                        ? this
                            .curve
                            .pointFromX(s.add(this.curve.n), u)
                        : this
                            .curve
                            .pointFromX(s, u);
                    var h = t
        ...
        20: [
            function (e, t, r) {
                ...
                o.prototype._importPublic = function (e, t) {
                    if (e.x || e.y) 
                        return "mont" === this.ec.curve.type
                            ? i(e.x, "Need x coordinate")
                            : "short" !== this.ec.curve.type && "edwards" !== this.ec.curve.type || i(
                                e.x && e.y,
        ...
        21: [
            function (e, t, r) {
                ...
                function f(e, t) {
                    ...
                    if (48 !== e[r.place++]) 
                        return !1;
                    if (h(e, r) + r.place !== e.length) 
                        return !1;
                    if (2 !== e[r.place++]) 
                        return !1;
                    var n = h(e, r),
                        i = e.slice(r.place, n + r.place);
                    if (r.place += n, 2 !== e[r.place++]) 
                        return !1;
                    var o = h(e, r);
                ...
                n.getJSF = function (e, t) {
                    ...
                    for (var n = 0, i = 0; 0 < e.cmpn(-n) || 0 < t.cmpn(-i);) {
                        ...
                        if (3 === u && (u = -1), 3 === l && (l = -1), 0 == (1 & u)) 
                            ...
                            o = 3 !== (a = e.andln(7) + n & 7) && 5 !== a || 2 !== l
                                ? u
                                : -u;
                        if (r[0].push(o), 0 == (1 & l)) 
                            s = 0;
                        else 
                            s = 3 !== (a = t.andln(7) + i & 7) && 5 !== a || 2 !== u
                                ? l
                                : -l;
                        r[1].push(s),
                        2 * n === o + 1 && (n = 1 - n),
            ...
            function (e, t, r) {
                ...
                s.prototype._update = function (e, t) {
                    for (
                        ...
                        i = n,
                        n = d,
                        d = v(p(m(a, g(79 - c, u, l, h), e[M[c] + t], w(c)), E[c]), f),
                        a = f,
                        f = h,
                        h = p(l, 10),
                        l = u,
                ...
                (function (b, w) {
                    !function () {
                        ...
                        var e = "object" == typeof window
                            ? window
                            : {};
                        !e.JS_SHA3_NO_NODE_JS && "object" == typeof b && b.versions && b.versions.node && (
                            e = w
                        );
                        for (
                            var t = !e.JS_SHA3_NO_COMMON_JS && "object" == typeof _ && _.exports,
                            ...
                            for (var d = i[c], p = d.bits, v = 0; v < p.length; ++v) {
                                var y = d.name + "_" + p[v];
                                f.push(y),
                                l[y] = d.createMethod(p[v], d.padding)
                            }
                        function m(e, t, r) {
                            this.blocks = [],
                            this.s = [],
                        ...
                        m.prototype.update = function (e) {
                            ...
                            for (
                                ...
                                if (this.reset) 
                                    for (this.reset = !1, o[0] = this.block, r = 1; r < a + 1; ++r) 
                                        o[r] = 0;
                            if (t) 
                                                ...
                                                n < 2048
                                                    ...
                                                    : (
                                                        n < 55296 || 57344 <= n
                                                            ...
                                                            : (
                                                                n = 65536 + ((1023 & n) << 10 | 1023 & e.charCodeAt(++u)),
                        ...
                        m.prototype.toString = m.prototype.hex = function () {
                            ...
                            for (
                                ...
                                for (o = 0; o < t && s < n; ++o, ++s) 
                                    e = r[o],
                                    a += u[e >> 4 & 15] + u[15 & e] + u[e >> 12 & 15] + u[e >> 8 & 15] + u[e >> 20 & 15] +
                                            u[e >> 16 & 15] + u[e >> 28 & 15] + u[e >> 24 & 15];
                                s % t == 0 && (g(r), o = 0)
                            }
                            return i && (
                                e = r[o],
                        ...
                        m.prototype.buffer = m.prototype.arrayBuffer = function () {
                            ...
                            return i && (u[o] = r[o], e = e.slice(0, a)),
                            e
                        },
                        ...
                        var g = function (e) {
                            ...
                            for (n = 0; n < 48; n += 2) 
                                ...
                                t = (c = e[8] ^ e[18] ^ e[28] ^ e[38] ^ e[48]) ^ (s << 1 | a >>> 31),
                                r = (d = e[9] ^ e[19] ^ e[29] ^ e[39] ^ e[49]) ^ (a << 1 | s >>> 31),
                                e[0] ^= t,
                                e[1] ^= r,
                                e[10] ^= t,
                                e[11] ^= r,
            ...
            function (e, r, o) {
                (function (n) {
                    ...
                    function l(e) {
                        ...
                        function t(e) {
                            for (var t = 0, r = e.length; 64 <= r;) {
                                ...
                                for (i = 0; i < 16; i++) 
                                    o = t + 4 * i,
                                    S[i] = (255 & e[o]) << 24 | (255 & e[o + 1]) << 16 | (255 & e[o + 2]) << 8 | 255 & e[o + 3];
                                for (i = 16; i < 64; i++) 
                                    s = ((n = S[i - 2]) >>> 17 | n << 15) ^ (n >>> 19 | n << 13) ^ n >>> 10,
                                    a = ((n = S[i - 15]) >>> 7 | n << 25) ^ (n >>> 18 | n << 14) ^ n >>> 3,
                                    S[i] = (s + S[i - 7] | 0) + (a + S[i - 16] | 0) | 0;
                                for (i = 0; i < 64; i++) 
                                    s = (
                                        ((c >>> 6 | c << 26) ^ (c >>> 11 | c << 21) ^ (c >>> 25 | c << 7)) + (c & d ^~ c & p) | 0
                                    ) + (v + (y[i] + S[i] | 0) | 0) | 0,
                    ...
                    function P(e, t, r) {
                        ...
                        for (; 32 <= r;) 
                            u(),
                            a = a.concat(l(s.concat(l(o)))),
                            r -= 32;
                        return 0 < r && (u(), a = a.concat(l(s.concat(l(o))).slice(0, r))),
                        a
                    }
            ...
            function (e, t, r) {
                (function (y, e, t) {
                    !function (r, n) {
                        ...
                        function v(e) {
                            e.source === r && "string" == typeof e.data && 0 === e
                                .data
                                .indexOf(o) && d(+e.data.slice(o.length))
                        }
                    }(
                        "undefined" == typeof self
                            ? void 0 === e
        ...
        48: [
            function (e, t, r) {
                ...
                function d(e, t) {
                    var r = t || 0,
                        n = i;
                    return n[e[r++]] + n[e[r++]] + n[e[r++]] + n[e[r++]] + "-" + n[e[r++]] + n[e[r++]] +
        ...
        51: [
            function (e, t, r) {
                ...
                function N(e) {
                    ...
                    var r = b(k, e),
                        n = e.networkId;
                    return null != e.chainId && null == n && null == r.v && (n = e.chainId),
                    u.isHexString(n) && (n = a.bigNumberify(n).toNumber()),
                    "number" != typeof n && null != r.v && (
                        (n = (r.v - 35) / 2) < 0 && (n = 0),
                        n = parseInt(n)
                    ),
                    "number" != typeof n && (n = 0),
                    ...
                    return e
                        .map(function (e) {
                            return "string" == typeof e
                                ...
                                : Array.isArray(e)
                                    ? (e.forEach(function (e) {
                                        null !== e && 32 !== u.hexDataLength(e) && m.throwError(
                                            "invalid topic",
                                            m.INVALID_ARGUMENT,
                                            {
                                                argument: "topic",
                    ...
                    q = (
                                                    ...
                                                    case "filter":
                                                        ...
                                                        u
                                                            ...
                                                            .then(function (e) {
                                                                if (0 !== e.length) 
                                                                    return e.forEach(function (e) {
                                                                        u._emitted["b:" + e.blockHash] = e.blockNumber,
                                                                        u._emitted["t:" + e.transactionHash] = e.blockNumber,
                                                                        u.emit(o, e)
                                                                    }),
                                                                    null
                                                            })
                        ...
                        Object.defineProperty(W.prototype, "polling", {
                            ...
                            set: function (e) {
                                ...
                                setTimeout(function () {
                                    e && !t._poller
                                        ? (t._poller = setInterval(t._doPoll.bind(t), t.pollingInterval), t._doPoll())
                                        : !e && t._poller && (clearInterval(t._poller), t._poller = null)
                                }, 0)
                            },
                            enumerable: !0,
                            configurable: !0
                        ...
                        W.prototype._getFastBlockNumber = function () {
                            var t = this,
                                e = V();
                            return e - this._fastQueryDate > 2 * this._pollingInterval && (
                                this._fastQueryDate = e,
                                this._fastBlockNumberPromise = this.getBlockNumber().then(function (e) {
                                    return (null == t._fastBlockNumber || e > t._fastBlockNumber) && (
                        ...
                        W.prototype._setFastBlockNumber = function (e) {
                            null != this._fastBlockNumber && e < this._fastBlockNumber || (
                                ...
                                (null == this._fastBlockNumber || e > this._fastBlockNumber) && (this._fastBlockNumber = e, this._fastBlockNumberPromise = Promise.resolve(e))
                            )
                        },
                                ...
                                .then(function () {
                                    return r
                                        ...
                                        .then(function (e) {
                                            ...
                                            return r._setFastBlockNumber(t),
                                            t
                                        })
                                })
                        },
                        ...
                        W.prototype.getStorageAt = function (e, t, r) {
                            ...
                            return this
                                ...
                                .then(function () {
                                    return c
                                        .resolveProperties({addressOrName: e, position: t, blockTag: r})
                                        .then(function (e) {
                                            var t = e.addressOrName,
                                                r = e.position,
                                                n = e.blockTag;
                                ...
                                .then(function () {
                                    return c
                                        ...
                                        .then(function (e) {
                                            ...
                                            return n
                                                .perform("sendTransaction", r)
                                                .then(function (e) {
                                                    return n._wrapTransaction(p.parse(t), e)
                                                }, function (e) {
                                                    throw e.transaction = p.parse(t),
                        ...
                        W.prototype._wrapTransaction = function (r, e) {
                            ...
                            var t = r;
                            return null != e && r.hash !== e && m.throwError(
                            ...
                            t.wait = function (t) {
                                return 0 !== t && (n._emitted["t:" + r.hash] = "pending"),
                                n
                                    .waitForTransaction(r.hash, t)
                                    .then(function (e) {
                                        return null == e && 0 === t
                                            ? null
                                            : (
                                                n._emitted["t:" + r.hash] = e.blockNumber,
                                                0 === e.status && m.throwError("transaction failed", m.CALL_EXCEPTION, {
                                    ...
                                    return c
                                        ...
                                        .then(function (e) {
                                            ...
                                            try {
                                                var n = -128,
                                                    i = S(t);
                                                return u.isHexString(i) && (n = parseInt(i.substring(2), 16)),
                                                y.poll(function () {
                                                    return s
                                                        .perform("getBlock", {
                                                            blockTag: i,
                            ...
                            return this
                                ...
                                .then(function (e) {
                                    ...
                                    return i
                                        .call(r)
                                        .then(function (e) {
                                            if (32 !== u.hexDataLength(e)) 
                                                return null;
                                            var t = s.getAddress(u.hexDataSlice(e, 12));
                                            return t === l.AddressZero
                                                ? null
                                                : t
                                        })
                                })
                        ...
                        W.prototype.lookupAddress = function (n) {
                            ...
                            return this
                                ...
                                .then(function (e) {
                                    if (null == e) 
                                        return null;
                                    if ((e = e.substring(2)).length < 64) 
                                        return null;
                                    if ((e = e.substring(64)).length < 64) 
                                        return null;
                                    var t = a
                                        .bigNumberify("0x" + e.substring(0, 64))
                                        .toNumber();
                                    if (2 * t > (e = e.substring(64)).length) 
                                        return null;
                        ...
                        W.prototype.perform = function (e, t) {
                            return m.throwError(e + " not implemented", m.NOT_IMPLEMENTED, {operation: e}),
                            null
                        },
                        ...
                        W.prototype._addEventListener = function (
                            e,
                            t,
                            r
                        ) {
                            this
                                ._events
                                .push({tag: z(e), listener: t, once: r}),
                        ...
                        W.prototype.removeAllListeners = function (e) {
                            ...
                            return 0 === this._events.length && (this.polling = !1),
                            this
                        },
                ...
                function W(e) {
                    ...
                    if (m.checkNew(t, g.Provider), e instanceof Promise) 
                        c.defineReadOnly(t, "ready", e.then(function (e) {
                            return c.defineReadOnly(t, "_network", e),
                            e
                        })),
                        t
                            .ready
        ...
        52: [
            function (e, t, r) {
                    ...
                    y = (
                        ...
                        m.prototype.perform = function (e, t) {
                            ...
                            switch (this.apiKey && (i += "&apikey=" + this.apiKey), e) {
                                ...
                                case "getBalance":
                                    return n += "/api?module=account&action=balance&address=" + t.address,
                                    o(n += "&tag=" + t.blockTag + i, c);
                                case "getTransactionCount":
                                    return n += "/api?module=proxy&action=eth_getTransactionCount&address=" + t.address,
                                    o(n += "&tag=" + t.blockTag + i);
                                case "getCode":
                                    return n += "/api?module=proxy&action=eth_getCode&address=" + t.address,
                                    o(n += "&tag=" + t.blockTag + i, d);
                                case "getStorageAt":
                                    return n += "/api?module=proxy&action=eth_getStorageAt&address=" + t.address,
                                    n += "&position=" + t.position,
                                    o(n += "&tag=" + t.blockTag + i, d);
                                case "sendTransaction":
                                    return n += "/api?module=proxy&action=eth_sendRawTransaction&hex=" + t.signedTransaction,
                                    o(n += i).catch(function (e) {
                                        throw e.responseText && (
                                            0 <= e.responseText.toLowerCase().indexOf("insufficient funds") && h.throwError("insufficient funds", h.INSUFFICIENT_FUNDS, {}),
                                ...
                                case "getBlock":
                                    if (t.blockTag) 
                                        return n += "/api?module=proxy&action=eth_getBlockByNumber&tag=" + t.blockTag,
                                ...
                                case "getTransaction":
                                    return n += "/api?module=proxy&action=eth_getTransactionByHash&txhash=" + t.transactionHash,
                                    o(n += i);
                                case "getTransactionReceipt":
                                    return n += "/api?module=proxy&action=eth_getTransactionReceipt&txhash=" + t.transactionHash,
                                    o(n += i);
                                case "call":
                                    if (n += "/api?module=proxy&action=eth_call" + (
                                ...
                                case "estimateGas":
                                    var s;
                                    return n += "/api?module=proxy&action=eth_estimateGas&" + (
                                        s = (s = f(t.transaction)) && "&" + s
                                    ),
                                    o(n += i);
                                case "getLogs":
                                    ...
                                    try {
                                        if (
                                            t.filter.fromBlock && (n += "&fromBlock=" + p(t.filter.fromBlock)),
                                            t.filter.toBlock && (n += "&toBlock=" + p(t.filter.toBlock)),
                                            t.filter.blockHash
                                        ) 
                                            try {
                                                h.throwError(
                                        ...
                                        if (
                                            t.filter.address && (n += "&address=" + t.filter.address),
                                            ...
                                            n = n.then(function () {
                                                return null != t.blockHash
                                                    ...
                                                    : (
                                                        ...
                                                        null == t.blockHash
                                                            ? u.getTransaction(t.transactionHash).then(function (e) {
                                                                return r[t.transactionHash] = e.blockHash,
                                ...
                                case "getEtherPrice":
                                    return "homestead" !== this.network.name
                                        ? Promise.resolve(0)
                                        : (n += "/api?module=stats&action=ethprice", o(n += i, c).then(function (e) {
                                    ...
                                    l
                                        ...
                                        .then(function (e) {
                                            ...
                                            return e.forEach(function (t) {
                                                ...
                                                null == t.creates && null != t.contractAddress && (
                                                    t.creates = t.contractAddress
                                                );
                                                var e = s
                                                    .BaseProvider
                                                    .checkTransactionResponse(t);
                                                t.timeStamp && (e.timestamp = parseInt(t.timeStamp)),
                                                r.push(e)
                                            }),
                                            r
                                        })
                ...
                function m(e, t) {
                    ...
                    return u.defineReadOnly(r, "baseUrl", i),
                    u.defineReadOnly(r, "apiKey", t || "8FG3JMZ9USS4NTA6YKEKHINU56SEPPVBJR"),
                    r
                }
            ...
            function (e, t, r) {
                ...
                function u(t) {
                    ...
                    return t.forEach(function (e) {
                        null != e
                            ? null != n
                                ? n.name === e.name && n.chainId === e.chainId && (
                                    n.ensAddress === e.ensAddress || null == n.ensAddress && null == e.ensAddress
                ...
                function f(e) {
                    ...
                    return a.checkNew(t, f),
                    t._providers = e.slice(0),
                    t
                }
            ...
            function (e, t, r) {
                ...
                function d(e, t) {
                    ...
                    return u.isHexString("0x" + t, 16)
                        ...
                        : (
                            f.warn(
                                "The legacy INFURA apiAccesToken API is deprecated; please upgrade to a Project" +
                                " ID instead (see INFURA dshboard; https://infura.io)"
                            ),
        ...
        57: [
            function (e, t, r) {
                ...
                var m,
                    ...
                    w = (
                        ...
                        _.prototype.getAddress = function () {
                            ...
                            return this._address
                                ...
                                : this
                                    ...
                                    .send("eth_accounts", [])
                                    .then(function (e) {
                                        return e.length <= t._index && u.throwError(
                        ...
                        _.prototype.getBalance = function (e) {
                            return this
                                .provider
                                .getBalance(this.getAddress(), e)
                        },
                        _.prototype.getTransactionCount = function (e) {
                            return this
                                .provider
                                .getTransactionCount(this.getAddress(), e)
                        },
                                ...
                                .then(function (e) {
                                    ...
                                    n
                                        ...
                                        .then(function (e) {
                                            ...
                                            throw e.responseText && (
                                                0 <= e.responseText.indexOf("insufficient funds") && u.throwError("insufficient funds", u.INSUFFICIENT_FUNDS, {transaction: t}),
                                                0 <= e.responseText.indexOf("nonce too low") && u.throwError("nonce has already been used", u.NONCE_EXPIRED, {transaction: t}),
                                                0 <= e.responseText.indexOf("replacement transaction underpriced") && u.throwError("replacement fee too low", u.REPLACEMENT_UNDERPRICED, {transaction: t})
                                            ),
                                            e
                                        })
                                })
                        ...
                        _.prototype.signMessage = function (e) {
                            ...
                            return this
                                ...
                                .then(function (e) {
                                    return t
                                        .provider
                                        .send("eth_sign", [e.toLowerCase(), h.hexlify(r)])
                                })
                        },
                    ...
                    r
                        ? "string" == typeof r
                            ...
                            : "number" == typeof r
                                ...
                                : u.throwError("invalid address or index", u.INVALID_ARGUMENT, {
                    ...
                    E = (
                        ...
                        S.prototype.perform = function (e, t) {
                            switch (e) {
                                ...
                                case "sendTransaction":
                                    return this
                                        .send("eth_sendRawTransaction", [t.signedTransaction])
                                        .catch(function (e) {
                                            throw e.responseText && (
                                                0 < e.responseText.indexOf("insufficient funds") && u.throwError("insufficient funds", u.INSUFFICIENT_FUNDS, {}),
                                ...
                                case "getLogs":
                                    return t.filter && null != t.filter.address && (
                                        t.filter.address = y(t.filter.address)
                                    ),
                                    this.send("eth_getLogs", [t.filter])
                            }
                            return u.throwError(e + " not implemented", u.NOT_IMPLEMENTED, {operation: e}),
                            null
                        },
                            ...
                            if (null == this._pendingFilter) {
                                ...
                                (this._pendingFilter = n)
                                    .then(function (t) {
                                        return function e() {
                                            r
                                                .send("eth_getFilterChanges", [t])
                                                .then(function (e) {
                                                    if (r._pendingFilter != n) 
                                                        return null;
                                                    var t = Promise.resolve();
                                                    return e.forEach(function (e) {
                                                        r._emitted["t:" + e.toLowerCase()] = "pending",
                                                        t = t.then(function () {
                                                            return r
                                                                .getTransaction(e)
                                                                .then(function (e) {
                                                                    return r.emit("pending", e),
                                                                    null
                                                                })
                                                        })
                                                    }),
                ...
                function S(e, t) {
                    var n = this;
                    if (
                        "string" == typeof e && null === t && f.getNetwork(e) && (t = e, e = null),
                        t
                    ) 
                    ...
                    return u.checkNew(n, S),
                    e = e || "http://localhost:8545",
                    n.connection = "string" == typeof e
                        ? {
                            url: e
                        }
                        : e,
            ...
            function (e, t, r) {
                ...
                var s,
                    ...
                    f = (s = a.JsonRpcProvider, i(c, s), c.prototype.send = function (t, r) {
                        var o = this;
                        return "eth_sign" == t && this._web3Provider.isMetaMask && (
                            t = "personal_sign",
                            r = [
                                r[1], r[0]
                            ]
                ...
                function c(e, t) {
                    ...
                    return l.checkNew(r, c),
                    e && (
                        e.sendAsync
                            ? r._sendAsync = e.sendAsync.bind(e)
                            : e.send && (r._sendAsync = e.send.bind(e))
                    ),
                    e && r._sendAsync || l.throwError("invalid web3Provider", l.INVALID_ARGUMENT, {
                        arg: "web3Provider",
                        value: e
                    }),
        ...
        59: [
            function (e, t, r) {
                ...
                function b(e, t) {
                    ...
                    function n(e) {
                        throw new Error(
                            'unexpected character "' + r[e] + '" at position ' + e + ' in "' + r + '"'
                        )
                    }
                    e = e.replace(/\s/g, " ");
                    for (var i = {
                        ...
                        switch (a) {
                            ...
                            default:
                                o.state.allowType
                                    ? (o.type += a, o.state.allowParams = !0, o.state.allowArray = !0)
                                    : o.state.allowName
                ...
                r.parseSignature = function (e) {
                    if ("string" == typeof e) 
                        return "event " === (
                            e = (e = (e = e.replace(/\s/g, " ")).replace(/\(/g, " (").replace(/\)/g, ") ").replace(/\s+/g, " ")).trim()
                        ).substring(0, 6)
                            ? function (e) {
                                var t = {
                                        anonymous: !1,
                            ...
                            try {
                                ...
                                if (this.signed) {
                                    ...
                                    if (r = r.add(s.One).mul(s.NegativeOne), e.lt(r)) 
                                        throw new Error("out-of-bounds")
                                } else if (e.lt(s.Zero) || e.gt(s.MaxUint256.maskn(8 * this.size))) 
                                    throw new Error("out-of-bounds");
                                return e = e
                                    .toTwos(8 * this.size)
                                    .maskn(8 * this.size),
                ...
                function I(e, t, r, n) {
                    ...
                    return (i = x.call(this, e, o, o, n, !1) || this).size = t,
                    i.signed = r,
                    i
                }
                var T,
                    ...
                    O = (
                        ...
                        C.prototype.decode = function (e, t) {
                            try {
                                ...
                                throw "insufficient data for uint256 type" === e.reason && l.throwError(
                ...
                var L,
                    D = (
                        ...
                        B.prototype.decode = function (e, t) {
                            return e.length < t + 32 && l.throwError(
                                "insufficient data for " + this.name + " type",
                                l.INVALID_ARGUMENT,
                                {
                                    arg: this.localName,
                ...
                function H(e, t, r) {
                    ...
                    return e.length < t + 32 + n && l.throwError(
                ...
                var z,
                    V = (
                        ...
                        K.prototype.decode = function (e, t) {
                            ...
                            return r.value = this.coerceFunc("bytes", h.hexlify(r.value)),
                            r
                        },
                        K
                    );
                ...
                var q,
                    W = (
                        ...
                        Z.prototype.encode = function (e) {
                            return "string" != typeof e && l.throwError(
                        ...
                        Z.prototype.decode = function (e, t) {
                            var r = H(e, t, this.localName);
                            return r.value = this.coerceFunc("string", f.toUtf8String(r.value)),
                            r
                        },
                        Z
                    );
                ...
                function X(e, r) {
                    ...
                    e.length !== r.length && l.throwError(
                    ...
                    return n.forEach(function (e) {
                        e.dynamic
                            ? (u.set(R.encode(a), s), s += 32, u.set(e.value, a), a += J(e.value.length))
                ...
                var Q,
                    Y = (
                        ...
                        ee.prototype.encode = function (e) {
                            ...
                            l.checkArgumentCount(t, e.length, " in coder array" + (
                                this.localName
                                    ? " " + this.localName
                                    : ""
                            ));
                ...
                function ee(e, t, r, n) {
                    var i = this,
                        ...
                        s = -1 === r || t.dynamic;
                    return (i = Q.call(this, e, "array", o, n, s) || this).coder = t,
                    i.length = r,
                    i
                }
                var te,
                    re = (
                        ...
                        ne.prototype.decode = function (e, t) {
                            ...
                            return r.value = this.coerceFunc(this.type, r.value),
                            r
                        },
                        ne
                    );
                function ne(e, t, r) {
                    ...
                    var s = "tuple(" + o.join(",") + ")";
                    return (n = te.call(this, e, "tuple", s, r, i) || this).coders = t,
                    n
                }
                function ie(e) {
                    e = e.trim();
                ...
                function se(e, t) {
                    var r,
                        n = oe[t.type];
                    if (n) 
                        return new n(e, t.name);
                    if (r = t.type.match(p)) 
                        return (0 === (i = parseInt(r[2] || "256")) || 256 < i || i % 8 != 0) && l.throwError(
                    ...
                    if (r = t.type.match(d)) 
                        return (0 === (i = parseInt(r[1])) || 32 < i) && l.throwError(
                ...
                var ae = (ue.prototype.encode = function (e, t) {
                    e.length !== t.length && l.throwError(
                    ...
                    new re(this.coerceFunc, r, "_")
                        .decode(h.arrayify(t), 0)
                        .value
                }, ue);
                function ue(e) {
                    l.checkNew(this, ue),
        ...
        60: [
            function (e, t, r) {
                ...
                function v(e) {
                    var t = null;
                    if (
                        "string" != typeof e && u.throwError("invalid address", u.INVALID_ARGUMENT, {
                            arg: "address",
                            value: e
                        }),
                        ...
                        for (
                            e.substring(2, 4) !== p(e) && u.throwError("bad icap checksum", u.INVALID_ARGUMENT, {
                                arg: "address",
                                value: e
                            }),
                ...
                r.getIcapAddress = function (e) {
                    for (
                        var t = new i.default.BN(v(e).substring(2), 16).toString(36).toUpperCase();
                        t.length < 30;
                    ) 
                        t = "0" + t;
                ...
                r.getContractAddress = function (e) {
                    ...
                    var t = e.nonce;
                    return v("0x" + s.keccak256(a.encode([
                        v(e.from),
                ...
                r.getCreate2Address = function (e) {
                    ...
                    e.initCode && (
                        t
                            ? s.keccak256(e.initCode) !== t && u.throwError(
        ...
        63: [
            function (e, t, r) {
                ...
                function v(e) {
                    if (u.checkNew(this, v), a.setType(this, "BigNumber"), "string" == typeof e) 
                        s.isHexString(e)
                            ...
                            : "-" === e[0] && s.isHexString(e.substring(1))
                                ...
                                : e.match(/^-?[0-9]*$/)
                                    ...
                                    : u.throwError("invalid BigNumber string value", u.INVALID_ARGUMENT, {
                                        arg: "value",
                                        value: e
                                    });
        ...
        64: [
            function (e, t, r) {
                ...
                function h(e) {
                    if (
                        null == e && s.throwError("cannot convert null value to array", s.INVALID_ARGUMENT, {
                            arg: "value",
                            value: e
                        }),
                        a(e) && (e = e.toHexString()),
                ...
                function p(e) {
                    ...
                    if (function (e) {
                        ...
                        null == e.v && null == e.recoveryParam && s.throwError(
        ...
        65: [
            function (e, t, r) {
                ...
                r.namehash = function (e) {
                    ...
                    (e = e.toLowerCase()).match(h) || i.throwError(
        ...
        66: [
            function (e, t, r) {
                ...
                var M = (
                    ...
                    A.prototype._derive = function (e) {
                        ...
                        if (e & g) {
                            ...
                            r.set(d.arrayify(this.privateKey), 1),
                            t && (t += "'")
                        } else 
                            r.set(d.arrayify(this.publicKey));
                        ...
                        return this.privateKey
                            ...
                            : u = new v
                                .KeyPair(d.hexlify(o))
                                ._addPoint(this.publicKey),
                        new A(_, a, u, this.fingerprint, w(s), e, this.depth + 1, this.mnemonic, t)
                    },
                ...
                function A(e, t, r, n, i, o, s, a, u) {
                    ...
                    p.defineReadOnly(this, "address", v.computeAddress(this.publicKey)),
                ...
                function S(e, t) {
                    ...
                    return d.hexlify(
                        o.pbkdf2(i.toUtf8Bytes(e, i.UnicodeNormalizationForm.NFKD), r, 2048, 64, "sha512")
                    )
                }
                function k(e, t) {
                    t = t || c.langEn,
                    ...
                    for (
                        var n = d.arrayify(new Uint8Array(Math.ceil(11 * r.length / 8))),
                        i = 0,
                        o = 0;
                        o < r.length;
                        o++
                ...
                function N(e, t) {
                    if ((e = d.arrayify(e)).length % 4 != 0 || e.length < 16 || 32 < e.length) 
                    ...
                    r[r.length - 1] <<= s,
                    r[r.length - 1] |= o >> 8 - s,
                    (t = t || c.langEn).join(r.map(function (e) {
                        return t.getWord(e)
                    }))
                }
                r.HDNode = M,
                r.fromExtendedKey = function (e) {
                    var t = a
                        .Base58
                        .decode(e);
                    82 === t.length && u(t.slice(0, 78)) === e || f.throwError(
        ...
        67: [
            function (e, t, r) {
                ...
                var i,
                    ...
                    a = e("../utils/bytes"),
                    u = n(e("../errors"));
                (o = i = r.SupportedAlgorithms || (r.SupportedAlgorithms = {})).sha256 = "sha256",
                o.sha512 = "sha512",
                r.computeHmac = function (e, t, r) {
                    return i[e] || u.throwError(
        ...
        68: [
            function (e, t, r) {
                ...
                r.base64 = s;
                var a = e("./bignumber");
                r.BigNumber = a.BigNumber,
                r.bigNumberify = a.bigNumberify;
                var u = e("./bytes");
            ...
            function (e, t, r) {
                ...
                var b,
                    w = (
                        ...
                        _.prototype.encode = function (e) {
                            ...
                            try {
                                return this.sighash + f
                                    .defaultAbiCoder
                                    .encode(this.inputs, e)
                                    .substring(2)
                            } catch (e) {
                        ...
                        _.prototype.decode = function (t) {
                            try {
                                return f
                                    .defaultAbiCoder
                                    .decode(this.outputs, c.arrayify(t))
                            } catch (e) {
                ...
                var S,
                    k = (
                        ...
                        N.prototype.encodeTopics = function (e) {
                            var n = this;
                            e.length > this.inputs.length && v.throwError(
                                                    ...
                                                    : -1 !== r
                                                        ...
                                                        .substring(0, 5)
                                                            ...
                                                            : (
                                                                ...
                                                                i.push(c.hexZeroPad(c.hexlify(e), 32).toLowerCase())
                                                            )
                                        : null != e && v.throwError(
                        ...
                        N.prototype.decode = function (e, r) {
                            ...
                            if (this.inputs.forEach(function (e, t) {
                                e.indexed
                                    ? "string" === e.type || "bytes" === e.type || 0 <= e
                                        .type
                                        .indexOf("[") || "tuple" === e
                                        .type
                                        .substring(0, 5)
                ...
                function C(e) {
                    switch (e.type) {
                        ...
                        case "function":
                            ...
                            null != e.constant
                                ...
                                : null != e.stateMutability && (
                                    i = "view" == e.stateMutability || "pure" == e.stateMutability
                                );
                            t = new w({
                                inputs: e.inputs,
                                outputs: e.outputs,
                            ...
                            null == this.functions[t.signature] && p.defineReadOnly(
                                this.functions,
                                t.signature,
                                t
                            );
                        ...
                        case "event":
                            ...
                            e.name && null == this.events[e.name] && p.defineReadOnly(
                                this.events,
                                e.name,
                                t
                            ),
                            null == this.events[t.signature] && p.defineReadOnly(
                                this.events,
                                t.signature,
                                t
                            );
                        ...
                        for (var r in this.functions) 
                            if (-1 !== r.indexOf("(")) {
                                ...
                                if (n.sighash === t) {
                                    var i = f
                                        .defaultAbiCoder
                                        .decode(n.inputs, "0x" + e.data.substring(10));
                                    return new P({
                                        args: i,
                                        decode: n.decode,
                                        name: n.name,
                ...
                function D(t) {
                    if (v.checkNew(this, D), "string" == typeof t) {
                        ...
                        if (!Array.isArray(t)) 
                            return v.throwError("invalid abi", v.INVALID_ARGUMENT, {
                                arg: "abi",
                                value: t
                            }),
                            null
                    ...
                    var r = [];
                    t.forEach(function (e) {
                        "string" == typeof e && (e = f.parseSignature(e)),
                        r.push(e)
                    }),
                    p.defineReadOnly(this, "abi", p.deepCopy(r, !0)),
                    r.forEach(C, this),
                    this.deployFunction || C.call(this, {
                        type: "constructor",
                        inputs: []
                    }),
        ...
        70: [
            function (e, t, r) {
                ...
                function o(e) {
                    ...
                    return !(
                        !t.version || parseInt(t.version) !== t.version || 3 !== parseInt(t.version)
                    )
                }
        ...
        72: [
            function (e, t, r) {
                ...
                function i(r) {
                    return function (e) {
                        var t = [];
                        return e.InfuraProvider && t.push(new e.InfuraProvider(r)),
                ...
                r.getNetwork = function (e) {
                    ...
                    return i
                        ? (
                            0 !== e.chainId && e.chainId !== i.chainId && o.throwError("network chainId mismatch", o.INVALID_ARGUMENT, {
                                arg: "network",
                                value: e
                            }),
                            {
        ...
        74: [
            function (e, t, r) {
                ...
                r.checkProperties = function (t, r) {
                    t && "object" == typeof t || i.throwError(
                        "invalid object",
                        i.INVALID_ARGUMENT,
                        {
                            argument: "object",
        ...
        77: [
            function (e, t, r) {
                ...
                function p(e) {
                    ...
                    l.defineReadOnly(this, "privateKey", s.hexlify(t.priv.toArray("be", 32))),
                    l.defineReadOnly(this, "publicKey", "0x" + t.getPublic(!1, "hex")),
                    l.defineReadOnly(this, "compressedPublicKey", "0x" + t.getPublic(!0, "hex")),
                    l.defineReadOnly(this, "publicKeyBytes", t.getPublic().encode(null, !0))
                }
                function v(e, t) {
                    var r = s.arrayify(e);
                    if (32 !== r.length) 
                            ...
                            : 65 === r.length
                                ? t
                                    ? "0x" + c()
                                        ...
                                        .getPublic(!0, "hex")
                                    : s.hexlify(r)
                                : (h.throwError("invalid public or private key", h.INVALID_ARGUMENT, {
                                    arg: "key",
                                    value: "[REDACTED]"
                                }), null);
                    var n = new d(r);
                    return t
                        ? n.compressedPublicKey
                        : n.publicKey
                }
                function y(e) {
            ...
            function (e, t, r) {
                ...
                r.decrypt = function (e, t, d) {
                    function p(e, t) {
                        ...
                        }(e.slice(16, 32), r)).substring(2) !== M(v, "crypto/mac").toLowerCase()) 
                            return t(new Error("invalid password")),
                            null;
                        var n = function (e, t) {
                                if ("aes-128-ctr" !== M(v, "crypto/cipher")) 
                                    return null;
                    ...
                    return new Promise(function (i, o) {
                        ...
                        if (e && "string" == typeof e) 
                            if ("scrypt" === e.toLowerCase()) {
                                ...
                                if (0 != (r & r - 1)) 
                                    return void o(
                                        new Error("unsupported key-derivation function parameter value for N")
                                    );
                            ...
                            if (e) 
                                ...
                                if (A) {
                                    var c = B.randomBytes(16),
                                        ...
                                        y = new Date,
                                        m = y.getUTCFullYear() + "-" + U(y.getUTCMonth() + 1, 2) + "-" + U(
                                            y.getUTCDate(),
                                            2
                                        ) + "T" + U(y.getUTCHours(), 2) + "-" + U(y.getUTCMinutes(), 2) + "-" + U(
                                            y.getUTCSeconds(),
                                            2
                                        ) + ".0Z";
                                    f["x-ethers"] = {
                                        ...
                                        mnemonicCounter: L
                                            .hexlify(c)
                                            .substring(2),
                                        mnemonicCiphertext: L
                                            .hexlify(v)
                                            .substring(2),
                                        path: E,
                                        version: "0.1"
                                    },
                                    w.wordlist && "string" == typeof w.wordlist.locale && (
            ...
            function (e, t, r) {
                ...
                var i = e("./hdnode"),
                    ...
                    l = (
                        ...
                        h.prototype.computeSharedSecret = function (e) {
                            return this
                                .keyPair
                                .computeSharedSecret(o.arrayify(e))
                        },
                ...
                function h(e) {
                    ...
                    try {
                        ...
                        e.value && (
                            "number" == typeof e.value.length && (r.length = e.value.length),
                ...
                function o(e, r) {
                    ...
                    return e.forEach(function (e, t) {
                        n.push(function t(e, r, n) {
                            ...
                            var i = e.match(c);
                            if (i) {
                                if ((o = parseInt(i[2] || "256")) % 8 != 0 || 0 === o || 256 < o) 
            ...
            function (e, t, r) {
                ...
                r.serialize = function (r, e) {
                    ...
                    v.forEach(function (e) {
                        ...
                        e.length && t.length !== e.length && 0 < t.length && s.throwError(
                        ...
                        e.maxLength && (t = h.stripZeros(t)).length > e.maxLength && s.throwError(
                            "invalid length for " + e.name,
                            s.INVALID_ARGUMENT,
                            {
                                arg: "transaction" + e.name,
                    ...
                    null != r.chainId && 0 !== r.chainId && (
                        n.push(h.hexlify(r.chainId)),
                        n.push("0x"),
                        n.push("0x")
                    );
                    var t = d.encode(n);
                    ...
                    return 9 === n.length && (n.pop(), n.pop(), n.pop(), o += 2 * r.chainId + 8),
                    n.push(h.hexlify(o)),
                ...
                r.parse = function (e) {
                    var t = d.decode(e);
                    9 !== t.length && 6 !== t.length && s.throwError(
                ...
                r.populateTransaction = function (e, t, r) {
                    o
                        .Provider
                        .isProvider(t) || s.throwError("missing provider", s.INVALID_ARGUMENT, {
                        argument: "provider",
                        value: t
                    }),
            ...
            function (e, t, r) {
                ...
                function a(e, t) {
                    ...
                    for (var i = e.mod(r.tenPower).toString(); i.length < r.decimals;) 
                        i = "0" + i;
                    return i = i.match(/^([0-9]*[1-9]|0)(0*)/)[1],
                    e = e
                        .div(r.tenPower)
                        .toString() + "." + i,
                    n && (e = "-" + e),
                ...
                function u(e, t) {
                    ...
                    var r = d(t);
                    if (
                        "string" == typeof e && e.match(/^-?[0-9.,]+$/) || f.throwError("invalid decimal value", f.INVALID_ARGUMENT, {
                            arg: "value",
                            value: e
                        }),
                        0 === r.decimals
                    ...
                    n && (e = e.substring(1)),
                    "." === e && f.throwError("missing value", f.INVALID_ARGUMENT, {
                        arg: "value",
                        value: e
                    });
                    var i = e.split(".");
                    ...
                    for (
                        o = o || "0",
                        (s = s || "0").length > r.decimals && f.throwError("underflow occurred", f.NUMERIC_FAULT, {
                            operation: "division",
                            fault: "underflow"
                        });
                        s.length < r.decimals;
                    ...
                    var a = c.bigNumberify(o),
                        ...
                        l = a
                            .mul(r.tenPower)
                            .add(u);
                    return n && (l = l.mul(h.NegativeOne)),
                    l
                }
                i = "1",
                [
                ...
                r.commify = function (e) {
                    ...
                    (
                        2 < t.length || !t[0].match(/^-?[0-9]*$/) || t[1] && !t[1].match(/^[0-9]*$/) || "." === e || "-." === e
        ...
        85: [
            function (e, t, r) {
                ...
                function u(e, t) {
                            ...
                            if (n + o > e.length) {
                                ...
                                if (null !== a) 
                                    ...
                                    a <= 65535
                                        ...
                                        : (
                                            a -= 65536,
                                            r += String.fromCharCode(55296 + (a >> 10 & 1023), 56320 + (1023 & a))
                                        );
                                else if (!t) 
                    ...
                    return r
                }(n = s = r.UnicodeNormalizationForm || (r.UnicodeNormalizationForm = {})).current = "",
                n.NFC = "NFC",
                n.NFD = "NFD",
                n.NFKC = "NFKC",
                n.NFKD = "NFKD",
            ...
            function (e, t, r) {
                ...
                r.fetchJson = function (e, a, u) {
                    ...
                    if ("string" == typeof e) 
                        ...
                        if (
                            null == e.url && c.throwError("missing URL", c.MISSING_ARGUMENT, {arg: "url"}),
                            l = e.url,
                    ...
                    if (null != e.user && null != e.password) {
                            "https:" !== l.substring(0, 6) && !0 !== e.allowInsecure && c.throwError(
                    ...
                    return new Promise(function (n, i) {
                        ...
                        a
                            ? (o.open("POST", l, !0), r["content-type"] = {
                                key: "Content-Type",
                ...
                var s,
                    ...
                    w = (
                        ...
                        _.prototype.connect = function (e) {
                            return g
                                .Provider
                                .isProvider(e) || b.throwError("invalid provider", b.INVALID_ARGUMENT, {
                                argument: "provider",
                                value: e
                            }),
                        ...
                        _.prototype.getTransactionCount = function (e) {
                            ...
                            return this
                                .provider
                                .getTransactionCount(this.address, e)
                        },
                        _.prototype.sendTransaction = function (e) {
                            var t = this;
                            if (!this.provider) 
                                throw new Error("missing provider");
                            return null == e.nonce && (
                                (e = c.shallowCopy(e)).nonce = this.getTransactionCount("pending")
                            ),
                            y
                        ...
                        _.createRandom = function (e) {
                            ...
                            (e = e || {}).extraEntropy && (
                                t = a.arrayify(f.keccak256(a.concat([t, e.extraEntropy])).substring(0, 34))
                            );
        ...
        90: [
            function (e, t, r) {
                ...
                var o,
                    s = e("../utils/wordlist"),
                    a = "AbandonAbilityAbleAboutAboveAbsentAbsorbAbstractAbsurdAbuseAccessAccidentAccou" +
                            "ntAccuseAchieveAcidAcousticAcquireAcrossActActionActorActressActualAdaptAddAdd" +
                            "ictAddressAdjustAdmitAdultAdvanceAdviceAerobicAffairAffordAfraidAgainAgeAgentA" +
                            "greeAheadAimAirAirportAisleAlarmAlbumAlcoholAlertAlienAllAlleyAllowAlmostAlone" +
                            "AlphaAlreadyAlsoAlterAlwaysAmateurAmazingAmongAmountAmusedAnalystAnchorAncient" +
                            "AngerAngleAngryAnimalAnkleAnnounceAnnualAnotherAnswerAntennaAntiqueAnxietyAnyA" +
                            "partApologyAppearAppleApproveAprilArchArcticAreaArenaArgueArmArmedArmorArmyAro" +
                            "undArrangeArrestArriveArrowArtArtefactArtistArtworkAskAspectAssaultAssetAssist" +
                            "AssumeAsthmaAthleteAtomAttackAttendAttitudeAttractAuctionAuditAugustAuntAuthor" +
                            "AutoAutumnAverageAvocadoAvoidAwakeAwareAwayAwesomeAwfulAwkwardAxisBabyBachelor" +
                            "BaconBadgeBagBalanceBalconyBallBambooBananaBannerBarBarelyBargainBarrelBaseBas" +
                            "icBasketBattleBeachBeanBeautyBecauseBecomeBeefBeforeBeginBehaveBehindBelieveBe" +
                            "lowBeltBenchBenefitBestBetrayBetterBetweenBeyondBicycleBidBikeBindBiologyBirdB" +
                            "irthBitterBlackBladeBlameBlanketBlastBleakBlessBlindBloodBlossomBlouseBlueBlur" +
                            "BlushBoardBoatBodyBoilBombBoneBonusBookBoostBorderBoringBorrowBossBottomBounce" +
                            "BoxBoyBracketBrainBrandBrassBraveBreadBreezeBrickBridgeBriefBrightBringBriskBr" +
                            "occoliBrokenBronzeBroomBrotherBrownBrushBubbleBuddyBudgetBuffaloBuildBulbBulkB" +
                            "ulletBundleBunkerBurdenBurgerBurstBusBusinessBusyButterBuyerBuzzCabbageCabinCa" +
                            "bleCactusCageCakeCallCalmCameraCampCanCanalCancelCandyCannonCanoeCanvasCanyonC" +
                            "apableCapitalCaptainCarCarbonCardCargoCarpetCarryCartCaseCashCasinoCastleCasua" +
                            "lCatCatalogCatchCategoryCattleCaughtCauseCautionCaveCeilingCeleryCementCensusC" +
                            "enturyCerealCertainChairChalkChampionChangeChaosChapterChargeChaseChatCheapChe" +
                            "ckCheeseChefCherryChestChickenChiefChildChimneyChoiceChooseChronicChuckleChunk" +
                            "ChurnCigarCinnamonCircleCitizenCityCivilClaimClapClarifyClawClayCleanClerkClev" +
                            "erClickClientCliffClimbClinicClipClockClogCloseClothCloudClownClubClumpCluster" +
                            "ClutchCoachCoastCoconutCodeCoffeeCoilCoinCollectColorColumnCombineComeComfortC" +
                            "omicCommonCompanyConcertConductConfirmCongressConnectConsiderControlConvinceCo" +
                            "okCoolCopperCopyCoralCoreCornCorrectCostCottonCouchCountryCoupleCourseCousinCo" +
                            "verCoyoteCrackCradleCraftCramCraneCrashCraterCrawlCrazyCreamCreditCreekCrewCri" +
                            "cketCrimeCrispCriticCropCrossCrouchCrowdCrucialCruelCruiseCrumbleCrunchCrushCr" +
                            "yCrystalCubeCultureCupCupboardCuriousCurrentCurtainCurveCushionCustomCuteCycle" +
                            "DadDamageDampDanceDangerDaringDashDaughterDawnDayDealDebateDebrisDecadeDecembe" +
                            "rDecideDeclineDecorateDecreaseDeerDefenseDefineDefyDegreeDelayDeliverDemandDem" +
                            "iseDenialDentistDenyDepartDependDepositDepthDeputyDeriveDescribeDesertDesignDe" +
                            "skDespairDestroyDetailDetectDevelopDeviceDevoteDiagramDialDiamondDiaryDiceDies" +
                            "elDietDifferDigitalDignityDilemmaDinnerDinosaurDirectDirtDisagreeDiscoverDisea" +
                            "seDishDismissDisorderDisplayDistanceDivertDivideDivorceDizzyDoctorDocumentDogD" +
                            "ollDolphinDomainDonateDonkeyDonorDoorDoseDoubleDoveDraftDragonDramaDrasticDraw" +
                            "DreamDressDriftDrillDrinkDripDriveDropDrumDryDuckDumbDuneDuringDustDutchDutyDw" +
                            "arfDynamicEagerEagleEarlyEarnEarthEasilyEastEasyEchoEcologyEconomyEdgeEditEduc" +
                            "ateEffortEggEightEitherElbowElderElectricElegantElementElephantElevatorEliteEl" +
                            "seEmbarkEmbodyEmbraceEmergeEmotionEmployEmpowerEmptyEnableEnactEndEndlessEndor" +
                            "seEnemyEnergyEnforceEngageEngineEnhanceEnjoyEnlistEnoughEnrichEnrollEnsureEnte" +
                            "rEntireEntryEnvelopeEpisodeEqualEquipEraEraseErodeErosionErrorEruptEscapeEssay" +
                            "EssenceEstateEternalEthicsEvidenceEvilEvokeEvolveExactExampleExcessExchangeExc" +
                            "iteExcludeExcuseExecuteExerciseExhaustExhibitExileExistExitExoticExpandExpectE" +
                            "xpireExplainExposeExpressExtendExtraEyeEyebrowFabricFaceFacultyFadeFaintFaithF" +
                            "allFalseFameFamilyFamousFanFancyFantasyFarmFashionFatFatalFatherFatigueFaultFa" +
                            "voriteFeatureFebruaryFederalFeeFeedFeelFemaleFenceFestivalFetchFeverFewFiberFi" +
                            "ctionFieldFigureFileFilmFilterFinalFindFineFingerFinishFireFirmFirstFiscalFish" +
                            "FitFitnessFixFlagFlameFlashFlatFlavorFleeFlightFlipFloatFlockFloorFlowerFluidF" +
                            "lushFlyFoamFocusFogFoilFoldFollowFoodFootForceForestForgetForkFortuneForumForw" +
                            "ardFossilFosterFoundFoxFragileFrameFrequentFreshFriendFringeFrogFrontFrostFrow" +
                            "nFrozenFruitFuelFunFunnyFurnaceFuryFutureGadgetGainGalaxyGalleryGameGapGarageG" +
                            "arbageGardenGarlicGarmentGasGaspGateGatherGaugeGazeGeneralGeniusGenreGentleGen" +
                            "uineGestureGhostGiantGiftGiggleGingerGiraffeGirlGiveGladGlanceGlareGlassGlideG" +
                            "limpseGlobeGloomGloryGloveGlowGlueGoatGoddessGoldGoodGooseGorillaGospelGossipG" +
                            "overnGownGrabGraceGrainGrantGrapeGrassGravityGreatGreenGridGriefGritGroceryGro" +
                            "upGrowGruntGuardGuessGuideGuiltGuitarGunGymHabitHairHalfHammerHamsterHandHappy" +
                            "HarborHardHarshHarvestHatHaveHawkHazardHeadHealthHeartHeavyHedgehogHeightHello" +
                            "HelmetHelpHenHeroHiddenHighHillHintHipHireHistoryHobbyHockeyHoldHoleHolidayHol" +
                            "lowHomeHoneyHoodHopeHornHorrorHorseHospitalHostHotelHourHoverHubHugeHumanHumbl" +
                            "eHumorHundredHungryHuntHurdleHurryHurtHusbandHybridIceIconIdeaIdentifyIdleIgno" +
                            "reIllIllegalIllnessImageImitateImmenseImmuneImpactImposeImproveImpulseInchIncl" +
                            "udeIncomeIncreaseIndexIndicateIndoorIndustryInfantInflictInformInhaleInheritIn" +
                            "itialInjectInjuryInmateInnerInnocentInputInquiryInsaneInsectInsideInspireInsta" +
                            "llIntactInterestIntoInvestInviteInvolveIronIslandIsolateIssueItemIvoryJacketJa" +
                            "guarJarJazzJealousJeansJellyJewelJobJoinJokeJourneyJoyJudgeJuiceJumpJungleJuni" +
                            "orJunkJustKangarooKeenKeepKetchupKeyKickKidKidneyKindKingdomKissKitKitchenKite" +
                            "KittenKiwiKneeKnifeKnockKnowLabLabelLaborLadderLadyLakeLampLanguageLaptopLarge" +
                            "LaterLatinLaughLaundryLavaLawLawnLawsuitLayerLazyLeaderLeafLearnLeaveLectureLe" +
                            "ftLegLegalLegendLeisureLemonLendLengthLensLeopardLessonLetterLevelLiarLibertyL" +
                            "ibraryLicenseLifeLiftLightLikeLimbLimitLinkLionLiquidListLittleLiveLizardLoadL" +
                            "oanLobsterLocalLockLogicLonelyLongLoopLotteryLoudLoungeLoveLoyalLuckyLuggageLu" +
                            "mberLunarLunchLuxuryLyricsMachineMadMagicMagnetMaidMailMainMajorMakeMammalManM" +
                            "anageMandateMangoMansionManualMapleMarbleMarchMarginMarineMarketMarriageMaskMa" +
                            "ssMasterMatchMaterialMathMatrixMatterMaximumMazeMeadowMeanMeasureMeatMechanicM" +
                            "edalMediaMelodyMeltMemberMemoryMentionMenuMercyMergeMeritMerryMeshMessageMetal" +
                            "MethodMiddleMidnightMilkMillionMimicMindMinimumMinorMinuteMiracleMirrorMiseryM" +
                            "issMistakeMixMixedMixtureMobileModelModifyMomMomentMonitorMonkeyMonsterMonthMo" +
                            "onMoralMoreMorningMosquitoMotherMotionMotorMountainMouseMoveMovieMuchMuffinMul" +
                            "eMultiplyMuscleMuseumMushroomMusicMustMutualMyselfMysteryMythNaiveNameNapkinNa" +
                            "rrowNastyNationNatureNearNeckNeedNegativeNeglectNeitherNephewNerveNestNetNetwo" +
                            "rkNeutralNeverNewsNextNiceNightNobleNoiseNomineeNoodleNormalNorthNoseNotableNo" +
                            "teNothingNoticeNovelNowNuclearNumberNurseNutOakObeyObjectObligeObscureObserveO" +
                            "btainObviousOccurOceanOctoberOdorOffOfferOfficeOftenOilOkayOldOliveOlympicOmit" +
                            "OnceOneOnionOnlineOnlyOpenOperaOpinionOpposeOptionOrangeOrbitOrchardOrderOrdin" +
                            "aryOrganOrientOriginalOrphanOstrichOtherOutdoorOuterOutputOutsideOvalOvenOverO" +
                            "wnOwnerOxygenOysterOzonePactPaddlePagePairPalacePalmPandaPanelPanicPantherPape" +
                            "rParadeParentParkParrotPartyPassPatchPathPatientPatrolPatternPausePavePaymentP" +
                            "eacePeanutPearPeasantPelicanPenPenaltyPencilPeoplePepperPerfectPermitPersonPet" +
                            "PhonePhotoPhrasePhysicalPianoPicnicPicturePiecePigPigeonPillPilotPinkPioneerPi" +
                            "pePistolPitchPizzaPlacePlanetPlasticPlatePlayPleasePledgePluckPlugPlungePoemPo" +
                            "etPointPolarPolePolicePondPonyPoolPopularPortionPositionPossiblePostPotatoPott" +
                            "eryPovertyPowderPowerPracticePraisePredictPreferPreparePresentPrettyPreventPri" +
                            "cePridePrimaryPrintPriorityPrisonPrivatePrizeProblemProcessProduceProfitProgra" +
                            "mProjectPromoteProofPropertyProsperProtectProudProvidePublicPuddingPullPulpPul" +
                            "sePumpkinPunchPupilPuppyPurchasePurityPurposePursePushPutPuzzlePyramidQualityQ" +
                            "uantumQuarterQuestionQuickQuitQuizQuoteRabbitRaccoonRaceRackRadarRadioRailRain" +
                            "RaiseRallyRampRanchRandomRangeRapidRareRateRatherRavenRawRazorReadyRealReasonR" +
                            "ebelRebuildRecallReceiveRecipeRecordRecycleReduceReflectReformRefuseRegionRegr" +
                            "etRegularRejectRelaxReleaseReliefRelyRemainRememberRemindRemoveRenderRenewRent" +
                            "ReopenRepairRepeatReplaceReportRequireRescueResembleResistResourceResponseResu" +
                            "ltRetireRetreatReturnReunionRevealReviewRewardRhythmRibRibbonRiceRichRideRidge" +
                            "RifleRightRigidRingRiotRippleRiskRitualRivalRiverRoadRoastRobotRobustRocketRom" +
                            "anceRoofRookieRoomRoseRotateRoughRoundRouteRoyalRubberRudeRugRuleRunRunwayRura" +
                            "lSadSaddleSadnessSafeSailSaladSalmonSalonSaltSaluteSameSampleSandSatisfySatosh" +
                            "iSauceSausageSaveSayScaleScanScareScatterSceneSchemeSchoolScienceScissorsScorp" +
                            "ionScoutScrapScreenScriptScrubSeaSearchSeasonSeatSecondSecretSectionSecuritySe" +
                            "edSeekSegmentSelectSellSeminarSeniorSenseSentenceSeriesServiceSessionSettleSet" +
                            "upSevenShadowShaftShallowShareShedShellSheriffShieldShiftShineShipShiverShockS" +
                            "hoeShootShopShortShoulderShoveShrimpShrugShuffleShySiblingSickSideSiegeSightSi" +
                            "gnSilentSilkSillySilverSimilarSimpleSinceSingSirenSisterSituateSixSizeSkateSke" +
                            "tchSkiSkillSkinSkirtSkullSlabSlamSleepSlenderSliceSlideSlightSlimSloganSlotSlo" +
                            "wSlushSmallSmartSmileSmokeSmoothSnackSnakeSnapSniffSnowSoapSoccerSocialSockSod" +
                            "aSoftSolarSoldierSolidSolutionSolveSomeoneSongSoonSorrySortSoulSoundSoupSource" +
                            "SouthSpaceSpareSpatialSpawnSpeakSpecialSpeedSpellSpendSphereSpiceSpiderSpikeSp" +
                            "inSpiritSplitSpoilSponsorSpoonSportSpotSpraySpreadSpringSpySquareSqueezeSquirr" +
                            "elStableStadiumStaffStageStairsStampStandStartStateStaySteakSteelStemStepStere" +
                            "oStickStillStingStockStomachStoneStoolStoryStoveStrategyStreetStrikeStrongStru" +
                            "ggleStudentStuffStumbleStyleSubjectSubmitSubwaySuccessSuchSuddenSufferSugarSug" +
                            "gestSuitSummerSunSunnySunsetSuperSupplySupremeSureSurfaceSurgeSurpriseSurround" +
                            "SurveySuspectSustainSwallowSwampSwapSwarmSwearSweetSwiftSwimSwingSwitchSwordSy" +
                            "mbolSymptomSyrupSystemTableTackleTagTailTalentTalkTankTapeTargetTaskTasteTatto" +
                            "oTaxiTeachTeamTellTenTenantTennisTentTermTestTextThankThatThemeThenTheoryThere" +
                            "TheyThingThisThoughtThreeThriveThrowThumbThunderTicketTideTigerTiltTimberTimeT" +
                            "inyTipTiredTissueTitleToastTobaccoTodayToddlerToeTogetherToiletTokenTomatoTomo" +
                            "rrowToneTongueTonightToolToothTopTopicToppleTorchTornadoTortoiseTossTotalTouri" +
                            "stTowardTowerTownToyTrackTradeTrafficTragicTrainTransferTrapTrashTravelTrayTre" +
                            "atTreeTrendTrialTribeTrickTriggerTrimTripTrophyTroubleTruckTrueTrulyTrumpetTru" +
                            "stTruthTryTubeTuitionTumbleTunaTunnelTurkeyTurnTurtleTwelveTwentyTwiceTwinTwis" +
                            "tTwoTypeTypicalUglyUmbrellaUnableUnawareUncleUncoverUnderUndoUnfairUnfoldUnhap" +
                            "pyUniformUniqueUnitUniverseUnknownUnlockUntilUnusualUnveilUpdateUpgradeUpholdU" +
                            "ponUpperUpsetUrbanUrgeUsageUseUsedUsefulUselessUsualUtilityVacantVacuumVagueVa" +
                            "lidValleyValveVanVanishVaporVariousVastVaultVehicleVelvetVendorVentureVenueVer" +
                            "bVerifyVersionVeryVesselVeteranViableVibrantViciousVictoryVideoViewVillageVint" +
                            "ageViolinVirtualVirusVisaVisitVisualVitalVividVocalVoiceVoidVolcanoVolumeVoteV" +
                            "oyageWageWagonWaitWalkWallWalnutWantWarfareWarmWarriorWashWaspWasteWaterWaveWa" +
                            "yWealthWeaponWearWeaselWeatherWebWeddingWeekendWeirdWelcomeWestWetWhaleWhatWhe" +
                            "atWheelWhenWhereWhipWhisperWideWidthWifeWildWillWinWindowWineWingWinkWinnerWin" +
                            "terWireWisdomWiseWishWitnessWolfWomanWonderWoodWoolWordWorkWorldWorryWorthWrap" +
                            "WreckWrestleWristWriteWrongYardYearYellowYouYoungYouthZebraZeroZoneZoo",
                    u = null;
                function l(e) {
                    if (null == u && (
                        u = a.replace(/([A-Z])/g, " $1").toLowerCase().substring(1).split(" "),
